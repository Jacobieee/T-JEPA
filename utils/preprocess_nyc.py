...
def join_data(f1, f2, f3):
    ...
    df.to_csv('../data/nyc_raw.csv', index=False)
...
def process_ca(file):
    ...
    traj.to_csv('../data/nyc.csv', index=False)
    print(traj)
...
def clean_and_output_data():
    ...
    dfraw = pd.read_csv(Config.root_dir + '/data/nyc.csv')
    # print(dfraw)
...
if __name__ == '__main__':
    ...
    # join_data("../nyc/train_sample.csv", "../nyc/validate_sample_with_traj.csv", "../nyc/test_sample_with_traj.csv")
    # get_mbr("../data/nyc_raw.csv")
    # process_ca("../data/nyc_raw.csv")
