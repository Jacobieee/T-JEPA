...
class Config:
    ...
    dataset_cell_file = ''
    dataset_embs_file = ''
    pretrain_use_all_data = False
    pretrain_skip_eval = False
    ...
    def post_value_updates(cls):
        cls.pretrain_use_all_data = False
        cls.pretrain_skip_eval = False
        ...
        cls.neighbours_file = cls.root_dir + '/data/' + cls.dataset_prefix + '_neighbours.pkl'
